    ...
    return (
        <div className="w-full max-w-[1200px] mx-auto">
            <div className="space-y-4 py-10">
                {/* Alert Section */}
                <div className="flex justify-center items-center py-7 bg-orange-100 rounded-lg shadow-md">
                    {/* Icon */}
                    <p className="text-2xl  mt-0 md:mt-[-10px] font-bold text-white-white-50 bg-yellow-500  px-5 py-2 rounded-full">!</p>
                    
                    {/* Text Section */}
                    <div className="ml-5 text-gray-900 w-full md:w-[50%] lg:w-[40%] text-center md:text-left">
